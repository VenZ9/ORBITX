        ...
        switch (type) {
            case SDL:
                if (action[0] == INIT) {
                    ...
                    try { System.loadLibrary("SDL3"); } catch (UnsatisfiedLinkError ignored) {}
                    try { System.loadLibrary("SDL2"); } catch (UnsatisfiedLinkError ignored) {}
                    ...
                    Logger.appendToLog("ORBITX: SDL support enabled!");
                    return true;
                }
        }
        return false;
