...
/**
 * ORBITX — Futuristic Cyber Reactor Client Installation & Download Visualizer.
...
public final class CsClientInstallView extends View {
    ...
    private String stageFor(int pct) {
        ...
        if (pct < 45) return "DEPLOYING ORBITX CLIENT CORE";
    ...
    private void drawTelemetryHUD(Canvas canvas, float cx, float cy, float w, float h) {
        ...
        // Main Title Header
        drawCenteredText(canvas, "ORBITX CLIENT CORE", cx, textTop, dp(20), 0xFFFFFFFF, true);
