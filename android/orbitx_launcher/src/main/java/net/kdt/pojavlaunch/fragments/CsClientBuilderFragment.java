...
/**
 * ORBITX CLIENT BUILDER — the page that answers, before anything is downloaded:
...
public class CsClientBuilderFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View r, @Nullable Bundle s) {
        ...
        ((TextView) r.findViewById(R.id.csc_builder_build))
                .setText("ORBITX CLIENT " + version.build + "  •  FABRIC");
    ...
    private void refresh() {
        ...
        addRow("ORBITX CLIENT", version.build, null, true, 45);
