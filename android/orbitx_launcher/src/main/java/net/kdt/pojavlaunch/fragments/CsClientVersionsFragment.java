...
/**
 * OrbitX Client — version picker (Aurora design, ORBITX V1.0).
 *
...
public class CsClientVersionsFragment extends Fragment {
            ...
            try {
                ...
                Tools.runOnUiThread(() -> {
                    ...
                    Toast.makeText(requireContext(),
                            "Could not load bundled OrbitX Client versions", Toast.LENGTH_LONG).show();
                });
            }
        });
    }
    ...
    private View makeCard(CsClientCatalog.VersionEntry e) {
        ...
        TextView sub = t("OrbitX Client " + e.build + " • bundled & verified", 9, 0xFF8A909C, false);
