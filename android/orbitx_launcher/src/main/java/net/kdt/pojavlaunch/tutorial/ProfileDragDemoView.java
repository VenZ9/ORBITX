...
public final class ProfileDragDemoView extends FrameLayout {
    ...
    private static final int   FINGER_COLOR     = 0xFFFF3B30;
    private static final int   FINGER_HIGHLIGHT = 0xFFFF6B6B;
    private static final int   FINGER_SHADOW    = 0x446B3FC6;
    private static final int   FINGER_BORDER    = 0xFFFF8A80;
    private static final float FINGER_SIZE_DP   = 46f;

    private static final int   GLOW_COLOR  = 0x3DFF3B30;
