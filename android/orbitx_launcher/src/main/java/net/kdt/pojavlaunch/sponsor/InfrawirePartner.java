...
/**
 * Central hub for the OrbitX Official Partner integration.
 *
...
public final class InfrawirePartner {
    ...
    public static final String NAME = "OrbitX";
    ...
    /**
     * Soft press-scale animation used across all OrbitX touchables.
