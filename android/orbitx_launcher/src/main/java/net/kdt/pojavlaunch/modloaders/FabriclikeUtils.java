...
public class FabriclikeUtils {
    ...
    private static final String TAG = "OrX";
    ...
    /** Every loader build the meta server knows, regardless of game version. */
    public FabricVersion[] downloadAllLoaderVersions() throws IOException {
        return downloadLoaderVersionsFromUrl(String.format(LOADER_METADATA_ALL_URL, mApiUrl),
                mCachePrefix + "_loader_versions.all");
    }
